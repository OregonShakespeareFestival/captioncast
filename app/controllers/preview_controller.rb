class PreviewController < ApplicationController
  ...
  def getLineSequence
    ...
    # if the current line sequence number doesn't exist
  	if(Rails.application.config.operator_positions[params[:operator]] == nil)
      line_sequence_number = 0 # throw back 0
    else
    ...
    # if the line sequence isn't at 0
    if(line_sequence_number != "0")
